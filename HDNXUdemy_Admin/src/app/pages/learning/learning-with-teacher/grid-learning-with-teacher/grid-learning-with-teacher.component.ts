...
@Component({
  selector: 'app-grid-learning-with-teacher',
  templateUrl: './grid-learning-with-teacher.component.html',
  styleUrls: ['./grid-learning-with-teacher.component.scss'],
  providers: [DecimalPipe]
})
export class GridLearningWithTeacherComponent {
