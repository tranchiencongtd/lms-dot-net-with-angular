...
@Component({
  selector: 'app-category-learning-online',
  templateUrl: './category-learning-online.component.html',
  styleUrls: ['./category-learning-online.component.scss'],
  providers: [DecimalPipe]

})
export class CategoryLearningOnlineComponent {
