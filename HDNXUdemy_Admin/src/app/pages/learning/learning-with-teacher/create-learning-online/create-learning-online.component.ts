...
@Component({
  selector: 'app-create-learning-online',
  templateUrl: './create-learning-online.component.html',
  styleUrls: ['./create-learning-online.component.scss']
})

// Create component
export class CreateLearningOnlineComponent {
